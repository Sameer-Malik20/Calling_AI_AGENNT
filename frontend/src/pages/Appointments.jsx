...
import { Calendar, Clock, User, Mail, Phone, MessageSquare, Send, X, CheckCircle, XCircle, Edit } from 'lucide-react';
...
const Appointments = () => {
  ...
  // Line 26-38 (fetchAppointments function)
const fetchAppointments = async () => {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-black text-slate-900 mb-2 uppercase tracking-tight">Appointments</h1>
                ...
                {selectedAppointment.status === 'SCHEDULED' && (
                  <>
                    <button
                      ...
                      className="flex items-center gap-2 px-5 py-3 bg-green-600 text-white rounded-xl text-sm font-black uppercase tracking-wider hover:bg-green-700 transition-all"
                    >
                      <CheckCircle size={16} />
                      Mark Complete
                    </button>
                    <button
                      ...
                      className="flex items-center gap-2 px-5 py-3 bg-red-600 text-white rounded-xl text-sm font-black uppercase tracking-wider hover:bg-red-700 transition-all"
                    >
                      <XCircle size={16} />
                      Cancel
                    </button>
